...
urlpatterns = [
    ...
    path("api/catalog/", views.api_catalog),
    path("api/product/<int:id>/", views.api_product),
    path("api/categories/", views.api_categories),
    
    path("api/basket/", views.api_basket),
    path("api/orders/", views.api_orders),
    path("api/tags/", views.api_tags),
    path("api/index/", views.api_index),

    path("api/products/popular", views.api_products_popular),
    path("api/products/limited", views.api_products_limited),
    path("api/banners", views.api_banners),
]
